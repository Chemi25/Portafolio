...
const translations = {
  ...
  es: {
    ...
    "hero.title": "Construyo webs, tiendas online y apps móviles.",
    "hero.subtitle": "Hola, soy José Miguel Batista, desarrollador freelance. Me ocupo del ciclo completo: diseño, desarrollo, SEO y automatización. Mi mejor carta de presentación es Planifesto, una plataforma de educación financiera que construí de cero y que hoy vende cursos y plantillas en español.",
  ...
  en: {
    ...
    "hero.title": "I build websites, online stores and mobile apps.",
    "hero.subtitle": "Hi, I'm José Miguel Batista, a freelance developer. I handle the full cycle: design, development, SEO and automation. My best calling card is Planifesto, a financial education platform I built from scratch that sells courses and templates in Spanish.",
